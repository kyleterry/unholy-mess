...
local function _1_()
  ...
  return treesitter.setup({highlight = {enable = true, additional_vim_regex_highlighting = false}, indent = {enable = true, disable = {"html"}}, incremental_selection = {enable = true, keymaps = {init_selection = "<c-space>", node_decremental = "<m-space>", node_incremental = "<c-space>", scope_incremental = "<c-s>"}}, select = {enable = true}, auto_install = true, ensure_installed = defaults})
end
