...
local function _2_()
  ...
  km("n", "<leader>fg", _3_, {noremap = true, desc = "[f]ind text with [g]rep"})
  ...
  km("n", "<leader>fn", _4_, {noremap = true, desc = "[f]ind [n]eovim files"})
  ...
  km("n", "<leader>fs", _5_, {noremap = true, desc = "[f]ind text with [s]tring"})
  km("n", "<leader>fc", builtin.commands, {noremap = true, desc = "[f]ind [c]ommands"})
  telescope.load_extension("ui-select")
  return telescope.load_extension("live_grep_args")
end
return {{"nvim-telescope/telescope.nvim", dependencies = {"nvim-telescope/telescope-ui-select.nvim", "nvim-telescope/telescope-live-grep-args.nvim", "nvim-lua/popup.nvim", "nvim-lua/plenary.nvim"}, config = _2_}}
