...
(let [km vim.keymap.set
      plugins {:olical/nfnl {}
               :mbbill/undotree {:config (fn []
                                           (km :n :<leader>u vim.cmd.UndotreeToggle {:desc "undotree toggle"}))}
              ...
              :ellisonleao/gruvbox.nvim {:priority 1000
               ...
               :potatoesmaster/i3-vim-syntax {:lazy true :ft [:i3]}
              
               ; tools
               :codethread/qmk.nvim {:config (fn []
                                               (let [qmk (require :qmk)]
                                                 (qmk.setup {})))}
               :kawre/leetcode.nvim {:dependencies [:muniftanjim/nui.nvim] :opts {:lang :go}}
               }]
  {})
